...
public class FangzujiaonaEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public FangzujiaonaEntity() {
		
	}
	
	public FangzujiaonaEntity(T t) {
		try {
	 ...
	 * 获取：房屋名称
	 */
	public String getFangwumingcheng() { return fangwumingcheng; }
	/**
	 * 设置：详细地址
	 */
