	...
	<div class="detail-preview" :style='{"width":"100%","margin":"0px auto","position":"relative","background":"none"}'>
		<div class="attr" :style='{"padding":"0px","margin":"0 auto","borderRadius":"4px","flexWrap":"wrap","background":"none","display":"flex","width":"85%","position":"relative"}'>
			...
			<div class="info" :style='{"border":"1px solid #eee","padding":"10px","margin":"0 0 0 5%","background":"rgba(255,255,255,.9)","display":"inline-block","width":"45%","minWidth":"540px","order":"2"}'>
				...
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"none","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#7e5ffb","textAlign":"right","width":"112px","fontSize":"14px","lineHeight":"40px","height":"40px"}'>租赁状态</div>
					<div  :style='{"width":"498px","padding":"8px 10px","fontSize":"14px","lineHeight":"24px","color":"#333"}'>{{detail.zulinzhuangtai}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0 0 10px 0","background":"none","display":"flex"}'>
				...
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#333","borderRadius":"4px","background":"#bdd87d","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="isAuth('fangwuzulin','预约看房')" @click="onAcross('yuyuekanfang','是','','')" type="warning">预约看房</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#333","borderRadius":"4px","background":"#bdd87d","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="isAuth('fangwuzulin','租赁')" @click="onAcross('zulindingdan','是','zulinzhuangtai','已租赁','已出租,未出租'.split(',')[0])" type="warning">租赁</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#333","borderRadius":"4px","background":"#c5ddfb","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="isAuth('fangwuzulin','审核')" @click="onSH" type="warning">审核</el-button>
				</div>
			</div>
