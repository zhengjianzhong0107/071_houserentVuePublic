<template>
	<div class="addEdit-block" :style='{"padding":"0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="租赁编号" prop="zulinbianhao">
					<el-input v-model="ruleForm.zulinbianhao" placeholder="租赁编号" clearable  :readonly="ro.zulinbianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="租赁编号" prop="zulinbianhao">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="房源分类" prop="fangyuanfenlei">
					<el-input v-model="ruleForm.fangyuanfenlei" placeholder="房源分类" clearable  :readonly="ro.fangyuanfenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="房源分类" prop="fangyuanfenlei">
					<el-input v-model="ruleForm.fangyuanfenlei" placeholder="房源分类" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="租赁时间" prop="zulinshijian">
					<el-input v-model="ruleForm.zulinshijian" placeholder="租赁时间" clearable  :readonly="ro.zulinshijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="租赁时间" prop="zulinshijian">
					<el-input v-model="ruleForm.zulinshijian" placeholder="租赁时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="退租时间" prop="tuizushijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.tuizushijian" label="退租时间" prop="tuizushijian">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `fangwutuizu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.fangwutuizuCrossAddOrUpdateFlag = false;
						 this.parent.search();
